...
#define LOW_PRECISION`),e}function tS(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Ud?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===__?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===di&&(e="SHADOWMAP_TYPE_VSM"),e}function nS(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case vr:case xr:e="ENVMAP_TYPE_CUBE";break;case qa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function iS(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case xr:e="ENVMAP_MODE_REFRACTION";break}return e}function sS(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Od:e="ENVMAP_BLENDING_MULTIPLY";break;case U_:e="ENVMAP_BLENDING_MIX";break;case O_:e="ENVMAP_BLENDING_ADD";break}return e}function rS(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function oS(r,e,t,n){const i=r.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=tS(t),c=nS(t),h=iS(t),u=sS(t),f=rS(t),d=qM(t),g=jM(s),_=i.createProgram();let m,p,x=t.glslVersion?"#version "+t.glslVersion+`
